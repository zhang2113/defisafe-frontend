module.exports = {
  home: {
    ...
    advantage: {
      ...
      desc_1: 'Defisafe creates a pool of venture capital through smart contracts that allow users to enjoy the added value of rising prices and share the risk of asset losses when prices fall。 | Smart contracts will put part of the funds (currently 5% of the total assets) into liquid lending platforms such as Uniswap, AAVE, Compound and so on to earn profits. This part of the funds will serve as a risk capital pool, which will be used to help users resist the risk of asset decline.',
